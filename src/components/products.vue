...
<script>
  export default {
    ...
    data() {
      return {
        products: [
          { name: "Mobiles", price: 20000, category: 'electronics' },
           { name: "Laptops", price: 50000, category: 'electronics' },
            { name: "Pens", price: 20, category: 'stationary' },
             { name: "pencils", price: 10, category: 'stationary' },
        ],
